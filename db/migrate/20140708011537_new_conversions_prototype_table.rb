class NewConversionsPrototypeTable < ActiveRecord::Migration
  def change
    create_prototype_table :conversions, :id => false, :options => 'DISTSTYLE KEY DISTKEY(tn_bid_id) SORTKEY (report_partition, event_time)', :partitioned => :monthly do |t|
