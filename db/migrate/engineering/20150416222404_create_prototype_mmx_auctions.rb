class CreatePrototypeMmxAuctions < ActiveRecord::Migration
  def change
    create_prototype_table :mmx_auctions, :id => false, :partitioned => :daily,
      ...
      t.string :exchange, :limit => 25, :encode => :bytedict
      t.string :device, :limit => 25, :encode => :bytedict
      t.string :size, :limit => 15, :encode => :bytedict
      t.column :app_site, 'char(4)', :encode => :lzo
      ...
      t.string :api_list, :limit => 10, :encode => :bytedict
