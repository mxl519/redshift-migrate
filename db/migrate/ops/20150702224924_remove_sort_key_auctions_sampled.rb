class RemoveSortKeyAuctionsSampled < ActiveRecord::Migration
  def up
    drop_table :prototype_auctions_sampled
    create_prototype_table :auctions_sampled, :id => false, :partitioned => :weekly do |t|
      ...
      t.integer :competitor_count, :limit => 2, :encode=> :mostly8
  ...
  def down
    drop_table :prototype_auctions_sampled
    create_prototype_table :auctions_sampled, :id => false, :partitioned => :weekly,
