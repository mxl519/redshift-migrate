class AddBigTileIdToEvents < ActiveRecord::Migration
  def change
    ...
    add_column :impressions, :big_tile_id, :string, :encode => :lzo, :limit => 30, :partitioned => :monthly
    add_column :win_notices, :big_tile_id, :string, :encode => :lzo, :limit => 30, :partitioned => :monthly
