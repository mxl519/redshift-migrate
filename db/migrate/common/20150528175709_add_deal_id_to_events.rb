class AddDealIdToEvents < ActiveRecord::Migration
  def change
    ...
    add_column :impressions, :deal_id, :string, :encode => :lzo, :limit => 100, :partitioned => :monthly
    ...
    add_column :win_notices, :deal_id, :string, :encode => :lzo, :limit => 100, :partitioned => :monthly
  end
end
