...
class CreateBids < ActiveRecord::Migration
  ...
  private
  def original_change
    create_table :bids_yyyymmdd, :id => false, :options => 'DISTSTYLE KEY DISTKEY(tn_bid_id) SORTKEY (report_partition, event_time)' do |t|
    ...
    grant_select :bids_yyyymmdd
    
    create_view :bids, :partitioned => :weekly
    grant_select :bids
  end
end
