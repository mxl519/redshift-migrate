class AddAppAdSpaceIdToEvents < ActiveRecord::Migration
  def change
    ...
    add_column :impressions, :app_ad_space_id, :string, :encode => :lzo, :limit => 100, :partitioned => :weekly
    add_column :win_notices, :app_ad_space_id, :string, :encode => :lzo, :limit => 100, :partitioned => :weekly
