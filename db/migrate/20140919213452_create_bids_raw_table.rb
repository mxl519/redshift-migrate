class CreateBidsRawTable < ActiveRecord::Migration
  def change
    create_prototype_table :bids_raw, :id => false, :partitioned => 'hourly', :options => 'DISTSTYLE KEY DISTKEY(tn_bid_id)' do |t|
